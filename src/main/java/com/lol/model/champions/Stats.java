...
public class Stats {
	...
	public Stats(double armorperlevel, double hpperlevel, double attackdamage, double mpperlevel,
			double attackspeedoffset, double armor, double hp, double hpregenperlevel, double spellblock,
			double attackrange, double movespeed, double attackdamageperlevel, double mpregenperlevel, double mp,
			double spellblockperlevel, double crit, double mpregen, double attackspeedperlevel, double hpregen,
			double critperlevel) {
		super();
